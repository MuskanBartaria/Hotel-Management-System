...
Aadhaar card Number<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

/Pan card Number:<input type="number" name="adhaar"/><br/><br/>
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<div class="logo2 pull-right" style="font-size:25px;"><br>

Login :<a href="login.php">Login up</a>
</div>
</div></div>
