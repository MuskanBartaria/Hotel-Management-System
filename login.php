...
<div class="logo" style="font-size:25px;">LOGIN</div>
<hr/>Name:&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name ="name" placeholder ="identity Number"/><br><br>

password:&nbsp;&nbsp;&nbsp;&nbsp;<input type="password" name ="pass" placeholder="password"/><br><br><br>

<input type="submit" name ="sub"/><div class="logo2 pull-right" style="font-size:25px;"><br>

New User :<a href="registeration.php">Sign up</a>
</div>
</form>
